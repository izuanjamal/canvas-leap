...
```bash
git remote add encore encore://canvas-leap-backend-t8ui
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/canvas-leap-backend-t8ui/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/canvas-leap-backend-t8ui/settings/integrations/github)
