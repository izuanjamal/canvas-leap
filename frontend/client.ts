...
export class Client {
    ...
    public readonly board: board.ServiceClient
    public readonly health: health.ServiceClient
    public readonly ws: ws.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.board = new board.ServiceClient(base)
        this.health = new health.ServiceClient(base)
        this.ws = new ws.ServiceClient(base)
    }
 ...
 */
import type { handler as auth_handler } from "~backend/auth/auth";
...
export interface ClientOptions {
     ...
     */
    auth?: RequestType<typeof auth_handler> | AuthDataGenerator
}
...
export namespace auth {
    ...
    export class ServiceClient {
         ...
         */
        public async me(): Promise<ResponseType<typeof api_auth_me_get_me>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/me`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_me_get_me>
        }
         ...
         */
        public async updateMe(params: RequestType<typeof api_auth_me_update_updateMe>): Promise<ResponseType<typeof api_auth_me_update_updateMe>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/me`, {method: "PATCH", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_me_update_updateMe>
        }
    }
}
...
export namespace board {
    ...
    export class ServiceClient {
         ...
         */
        public async createUser(params: RequestType<typeof api_board_create_user_createUser>): Promise<ResponseType<typeof api_board_create_user_createUser>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/users`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_board_create_user_createUser>
        }
        ...
        public async get(params: { id: string }): Promise<ResponseType<typeof api_board_get_get>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_board_get_get>
        }
        ...
        public async list(params: RequestType<typeof api_board_list_list>): Promise<ResponseType<typeof api_board_list_list>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/boards`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_board_list_list>
        }
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getActiveUsers as api_ws_active_users_getActiveUsers } from "~backend/ws/active_users";
import { boardSync as api_ws_board_sync_boardSync } from "~backend/ws/board_sync";
...
export namespace ws {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.boardSync = this.boardSync.bind(this)
         ...
         */
        public async getActiveUsers(params: { boardId: string }): Promise<ResponseType<typeof api_ws_active_users_getActiveUsers>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/boards/${encodeURIComponent(params.boardId)}/users`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_ws_active_users_getActiveUsers>
        }
    }
}
...
export type AuthDataGenerator = () =>
  | RequestType<typeof auth_handler>
  | Promise<RequestType<typeof auth_handler> | undefined>
  | undefined;
...
class BaseClient {
    ...
    async getAuthData(): Promise<CallParameters | undefined> {
        let authData: RequestType<typeof auth_handler> | undefined;
